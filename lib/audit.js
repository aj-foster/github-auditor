...
exports.queryRepos = async function (team) {
  let res = await global.client
    .request(queries.repoInitialBatch, {org: global.org, teamSlug: team})
    .then(data => data)
    .catch(err => {
      throw err
    })
...
exports.queryUsers = async function (team) {
  let res = await global.client
    .request(queries.userInitialBatch, {org: global.org, teamSlug: team})
    .then(data => data)
    .catch(err => {
      throw err
    })
